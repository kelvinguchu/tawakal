        ...
        <div className='relative'>
          ...
          <div className='mt-20'>
            <div className='bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 relative overflow-hidden'>
              ...
              {/* Hub visualization */}
              <div className='relative w-full max-w-2xl mx-auto h-[150px] my-8'>
                <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
                  <div className='w-20 h-20 rounded-full bg-gradient-to-r from-tawakal-green to-tawakal-blue flex items-center justify-center shadow-lg'>
                    <div className='text-center'>
                      <span className='text-2xl'>🇸🇴</span>
                      <p className='text-xs font-bold text-white'>SOMALIA</p>
                    </div>
                  </div>
                </div>
                ...
                <div className='absolute top-[30%] left-[20%] transform -translate-x-1/2 -translate-y-1/2'>
                  <div className='w-12 h-12 rounded-full bg-tawakal-green/20 flex items-center justify-center shadow-md'>
                    <span className='text-xl'>🌍</span>
                  </div>
                </div>

                <div className='absolute top-[30%] left-[80%] transform -translate-x-1/2 -translate-y-1/2'>
                  <div className='w-12 h-12 rounded-full bg-tawakal-blue/20 flex items-center justify-center shadow-md'>
                    <span className='text-xl'>🌎</span>
                  </div>
                </div>

                <div className='absolute top-[70%] left-[20%] transform -translate-x-1/2 -translate-y-1/2'>
                  <div className='w-12 h-12 rounded-full bg-tawakal-red/20 flex items-center justify-center shadow-md'>
                    <span className='text-xl'>🌏</span>
                  </div>
                </div>
