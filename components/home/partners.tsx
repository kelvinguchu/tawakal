  ...
  return (
    <section className='py-12 sm:py-16 md:py-24 relative overflow-hidden'>
      ...
      <div className='container mx-auto px-4'>
        ...
        <div className='relative w-full overflow-hidden mb-6 sm:mb-8 md:mb-12'>
          {/* Left vignette */}
          <div className='absolute left-0 top-0 bottom-0 w-16 sm:w-24 md:w-32 bg-gradient-to-r from-[#f9f9f9] to-transparent z-10'></div>

          {/* Right vignette */}
          <div className='absolute right-0 top-0 bottom-0 w-16 sm:w-24 md:w-32 bg-gradient-to-l from-[#f9f9f9] to-transparent z-10'></div>

          <motion.div
            className='flex gap-4 sm:gap-8 md:gap-12 items-center'
            ...
            {[
              ...
              <div
                ...
                className='flex-shrink-0 bg-white/80 backdrop-blur-md rounded-xl p-3 sm:p-4 md:p-6 shadow-lg border border-white/30 w-24 h-24 sm:w-36 sm:h-36 md:w-48 md:h-48 flex items-center justify-center hover:shadow-xl transition-all duration-300 hover:bg-white/90'>
                <div className='relative w-16 h-16 sm:w-24 sm:h-24 md:w-36 md:h-36'>
                  <Image
                    src={partner.logo}
                    alt={partner.name}
                    fill
        ...
        <div className='relative w-full overflow-hidden mb-8 sm:mb-12 md:mb-16'>
          {/* Left vignette */}
          <div className='absolute left-0 top-0 bottom-0 w-16 sm:w-24 md:w-32 bg-gradient-to-r from-[#f9f9f9] to-transparent z-10'></div>
        ...
        <div className='text-center mt-4 sm:mt-6 md:mt-8'>
          <motion.div
            ...
            viewport={{ once: true }}>
            <motion.button
              className='bg-gradient-to-r from-tawakal-green to-tawakal-blue text-white rounded-full px-5 py-3 sm:px-6 sm:py-3.5 md:px-8 md:py-4 text-sm sm:text-base shadow-md'
              whileHover={{
                scale: 1.05,
                boxShadow:
